...
export default function HaMoshavaMap() {
  ...
  const fieldCx = data.fieldCenter.x;
  const fieldCy = data.fieldCenter.y;
  ...
  return (
    <div className="flex flex-col w-full h-screen bg-gray-950 text-white overflow-hidden">
      ...
      <div className="flex items-center justify-between px-6 py-4 bg-gray-900 border-b border-gray-800 flex-shrink-0">
        <h1 className="text-xl font-bold">HaMoshava Stadium</h1>
      ...
      >
        ...
        >
          ...
          >
            ...
            {/* Football field */}
            <rect x={-1100} y={-600} width={2200} height={1200} rx={20}
              fill="#4caf50" stroke="#388e3c" strokeWidth={4} />
            <rect x={-1100} y={-600} width={2200} height={1200} rx={20}
              fill="none" stroke="#fff" strokeWidth={2} />
            {/* Center line */}
            <line x1={0} y1={-600} x2={0} y2={600} stroke="#fff" strokeWidth={1.5} />
            {/* Center circle */}
            <circle cx={0} cy={0} r={150} fill="none" stroke="#fff" strokeWidth={1.5} />
            <circle cx={0} cy={0} r={4} fill="#fff" />
            {/* Penalty areas */}
            <rect x={-1100} y={-300} width={250} height={600} fill="none" stroke="#fff" strokeWidth={1} />
            <rect x={850} y={-300} width={250} height={600} fill="none" stroke="#fff" strokeWidth={1} />
            {/* Goal areas */}
            <rect x={-1100} y={-150} width={100} height={300} fill="none" stroke="#fff" strokeWidth={1} />
            <rect x={1000} y={-150} width={100} height={300} fill="none" stroke="#fff" strokeWidth={1} />
            ...
            {GATE_POSITIONS.map(({ gate, x, y, label }) => (
              <g key={gate}>
                <rect x={x - 120} y={y - 40} width={240} height={80} rx={15}
                  fill="#8B0000" fillOpacity={0.9} />
                <text x={x} y={y + 10} textAnchor="middle" fill="white"
                  fontSize={45} fontWeight="bold" style={{ pointerEvents: 'none' }}>
                  {label}
                </text>
              </g>
            ))}
